...
<div class="row" style="margin-left: 8px; background-color: #fff">
            ...
            <c:forEach var="a" items="${value}" >
                ...
                <div class="column">
                    <div class="card" style="background-color:#fff">
                        <img src="${a.getCarimage()}"  style= "width :320px; height:320px " />
                        <div class="container">
                            <h5><b style="color:#000">${a.getCarname()}</b></h5>
                            <p style="background-color: gray; width:300px; padding: 10px"><b  style="color: red"> Rs./- </b><b style="color: black">${a.getCarprice()}</b> <input style="margin-left: 120px" class ="btn btn-danger" data-toggle="modal" data-target="#myModal" type="button" value="Book Now"></p>
                        </div>
                    </div>
                </div>
            </c:forEach>
